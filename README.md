...
interactive dashboarding, and business reporting).
...
| `IPL_Dashboard.html` | Interactive dashboard — KPI cards, season filter, and live charts. Opens in any browser, no software needed. |
...
Double-click `IPL_Dashboard.html` (or open it in any browser). Use the season chips
at the top to filter the team, player, toss, and phase charts; the venue/trend/margin
charts stay fixed as a full-history reference view.

**PDF Report:**
Open `IPL_Insights_Report.pdf` directly — ready to share or present.

## 🧰 Tools Used
Python (pandas, matplotlib, numpy) · Jupyter Notebook · Chart.js (dashboard) · ReportLab (PDF generation)
